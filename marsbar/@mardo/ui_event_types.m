...
cb = 'cbD = get(findobj(''Tag'', ''ui_event_types''),''UserData''); ';
...
hDone = uicontrol(F,...
		  ...
		  'ForegroundColor','k',...
		  'Tag','Done','UserData',-1,...
		  'Callback',[cb 'ui_event_types_cb(cbD, ''OK'')'] ,...
...
uicontrol(F,...
	  ...
	  'Callback',[cb 'ui_event_types_cb(cbD, ''Cancel'')'] ,...
	  'Interruptible','off','BusyAction','Cancel',...
...
uicontrol(F,...
	  ...
	  'Callback',[cb 'ui_event_types_cb(cbD, ''Delete'')'] ,...
	  'Interruptible','off','BusyAction','Cancel',...
...
uicontrol(F,...
	  ...
	  'ForegroundColor','k',...
	  'Tag','New','UserData',-1,...
	  'Callback',[cb 'ui_event_types_cb(cbD, ''New'')'] ,...
	  'Interruptible','off','BusyAction','Cancel',...
