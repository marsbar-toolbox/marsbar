...
cb = 'D = get(findobj(''Tag'', ''ui_event_types''),''UserData''); ';
...
hDone = uicontrol(F,...
		  ...
		  'ForegroundColor','k',...
		  'Tag','Done','UserData',-1,...
		  'Callback',[cb 'ui_event_types_cb(D, ''OK'')'] ,...
...
uicontrol(F,...
	  ...
	  'Callback',[cb 'ui_event_types_cb(D, ''Cancel'')'] ,...
	  'Interruptible','off','BusyAction','Cancel',...
...
uicontrol(F,...
	  ...
	  'Callback',[cb 'ui_event_types_cb(D, ''Delete'')'] ,...
	  'Interruptible','off','BusyAction','Cancel',...
...
uicontrol(F,...
	  ...
	  'ForegroundColor','k',...
	  'Tag','Edit','UserData',-1,...
	  'Callback',[cb 'ui_event_types_cb(D, ''Edit'')'] ,...
	  'Interruptible','off','BusyAction','Cancel',...
...
uicontrol(F,...
	  ...
	  'ForegroundColor','k',...
	  'Tag','New','UserData',-1,...
	  'Callback',[cb 'ui_event_types_cb(D, ''New'')'] ,...
	  'Interruptible','off','BusyAction','Cancel',...
