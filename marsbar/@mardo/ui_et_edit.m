function [et, ic] = ui_et_edit(D, ic)
% method to edit invidual event types in design
% FORMAT [et, ic] = ui_et_edit(D, ic)
% 
% D         - design object
...
cb = 'D = get(findobj(''Tag'', ''ui_et_edit''),''UserData''); ';
...
elist_sz(2)   = (win_sz(2) - elist_border(2)*2 - gap_b - space_b)/2;
elist_OUT_pos = elist_border;
elist_IN_pos  = [elist_border(1) elist_border(2) + elist_sz(2) + ...
		 space_b];
...
hDone = uicontrol(F,...
		  ...
		  'ForegroundColor','k',...
		  'Tag','ui_et_done', ...
		  'Callback',[cb 'ui_et_edit_cb(D, ''OK'')'] ,...
...
uicontrol(F,...
	  ...
	  'ForegroundColor','k',...
	  'Tag','ui_et_cancel',...
	  'Callback',[cb 'ui_et_edit_cb(D, ''Cancel'')'] ,...
	  'Interruptible','off','BusyAction','Cancel',...
