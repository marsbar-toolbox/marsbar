...
uicontrol(F,...
	  ...
	  'ForegroundColor','k',...
	  'Tag','ui_et_add',...
	  'Callback',[cb 'ui_et_edit_cb(cbD, ''Add'')'] ,...
	  'Interruptible','off','BusyAction','Cancel',...
...
uicontrol(F,...
	  ...
	  'ForegroundColor','k',...
	  'Tag','ui_et_remove',...
	  'Callback',[cb 'ui_et_edit_cb(cbD, ''Remove'')'] ,...
	  'Interruptible','off','BusyAction','Cancel',...
...
uicontrol(F,...
	  ...
	  'ForegroundColor','k',...
	  'Tag','ui_et_sort',...
	  'Callback',[cb 'ui_et_edit_cb(cbD, ''Sort'')'] ,...
	  'Interruptible','off','BusyAction','Cancel',...
...
hListOUT = uicontrol(F,'Style','ListBox','Tag','ui_et_OUT',...
		     'ToolTipString',['Select events(s) - drag/shift-click',...
		    '/ctrl-click to select multiple events'],...
		     'UserData', OUT_evs,...
