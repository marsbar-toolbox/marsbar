function [et, ic, status] = ui_mevent(et)
% ui method for selection / editing of event types
% FORMAT [et, ic] = ui_mevent(et)
% 
% Input
...
% ic         - indices of selected objects (empty for none)
...
[F hDone hList] = sf_start_window(et)
...
function [F, hDone, hList] = sf_start_window(et)
...
uicontrol(F,...
	  ...
	  'Callback',[cb 'ui_mevent_cb(et, ''Delete'')'] ,...
	  'Interruptible','off','BusyAction','Cancel',...
...
uicontrol(F,...
	  ...
	  'ForegroundColor','k',...
	  'Tag','Edit','UserData',-1,...
	  'Callback',[cb 'ui_mevent_cb(et, ''Edit'')'] ,...
	  'Interruptible','off','BusyAction','Cancel',...
