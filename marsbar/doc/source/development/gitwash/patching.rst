...
You've discovered a bug or something else you want to change in marsbar_ - excellent!
...
::
   ...
   git clone git://github.com/matthew-brett/marsbar.git
...
Then, send the generated patch files to the `marsbar mailing list`_ - where we will thank you warmly.
...
#. If you don't already have one, clone a copy of the marsbar_ repository::
...
#. Finally, make your commits into patches.  You want all the commits
   ...
   Send these files to the `marsbar mailing list`_.
...
Fork the marsbar_ repository on github_ - :ref:`forking`.  Then::
   ...
   git remote add origin git@github.com:your-user-name/marsbar.git
