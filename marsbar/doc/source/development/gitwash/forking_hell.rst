...
==========================================
Making your own copy (fork) of marsbar
==========================================
...
specifics for the marsbar_ project, and to suggest some default names.
...
Create your own forked copy of marsbar_
=========================================

#. Log into your github_ account.
#. Go to the marsbar_ github home at `marsbar github`_.
#. Click on the *fork* button:

   .. image:: forking_button.png

   Now, after a short pause and some 'Hardcore forking action', you
   should find yourself at the home page for your own forked copy of marsbar_.
